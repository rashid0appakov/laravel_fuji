(function ($) {
	...
	"use strict";
	if(window.localStorage.getItem('dark')) $('body').addClass('bg-dark dark')
	$('.theme-toggle').click(function(e){
		e.preventDefault();
		window.localStorage.setItem('dark', $('body').hasClass('dark') ? '': '1');
		$('body').toggleClass('bg-dark dark');
	})
	$(window).on('load', function () {
		...
		$('#accept_rules').change(function(){
			$('#reg_button').attr('disabled', !$(this).prop('checked'))
		})
